...
from insertdb2 import MainInsert
...
class TK:
    ...
    def register(self):
        ...
        message1 = MainFunction.show_details_for_person(persoana1)

        # Show success message
        messagebox.showinfo("Validation Successful", message1)
    ...
    def add_function(self):
        ...
        # Insert into DB2
        db2_data = MainInsert(name, surname, cnp)
        db2_data.database()
        # Show success message
        messagebox.showinfo("Add Successful", "Successful added to database")
